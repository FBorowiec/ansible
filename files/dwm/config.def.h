...
static const int user_bh = 70; /* 0 means that dwm will calculate bar height, >=
...
static const char *goingout[] = {"/usr/bin/nwgbar", "-o", "0.2", "-t",
                                 "dwm.json",        NULL};
...
static const char *dmenucmd[] = {
    "/bin/sh", "-c", "rofi -show drun -config ~/rofi-spotlight/rofi.rasi",
    NULL};
...
static Key keys[] = {
    ...
    TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3)
        TAGKEYS(XK_5, 4) TAGKEYS(XK_6, 5) TAGKEYS(XK_7, 6) TAGKEYS(XK_8, 7)
            TAGKEYS(XK_9, 8){MODKEY | ShiftMask, XK_q, spawn, {.v = goingout}},
